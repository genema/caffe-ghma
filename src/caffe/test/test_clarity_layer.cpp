/*
* @Author: gehuama
* @Date:   2017-12-12 10:56:23
* @Last Modified by:   gehuama
* @Last Modified time: 2017-12-12 11:08:45
*/
#include <cmath>
#include <vector>
...
class ClarityLossLayerTest : public MultiDeviceTest<TypeParam> {
  typedef typename TypeParam::Dtype Dtype;

 protected:
  ClarityLossLayerTest()
      : blob_bottom_data_x_(new Blob<Dtype>(10, 5, 1, 1)),
        blob_bottom_data_ygt_(new Blob<Dtype>(10, 5, 1, 1)),
        blob_bottom_data_yr_(new Blob<Dtype>(10, 5, 1, 1)),
